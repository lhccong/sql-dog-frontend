 ...
 */
export const useCheckResult = (result: QueryExecResult[], answerResult: QueryExecResult[]) => {
  const [status, setStatus] = useState(RESULT_STATUS_ENUM.DEFAULT);
  ...
  useEffect(() => {
    ...
    const resultStatus = checkResult(result, answerResult);
